...
export default class spservices {
  ...
  //   let hasPermissionAdd: boolean = true;
  //   let hasPermissionEdit: boolean = true;
  //   let hasPermissionDelete: boolean = true;
  //   let hasPermissionView: boolean = true;
  ...
  //     const res = await this.context.msGraphClientFactory
  //       .getClient()
  ...
  //         if (res && res.Row.length > 0) {
  //           let event: any = "";
  //           for (event of res.Row) {
  //           }
  //           return res;
  //         }
  //       });
